...
const iconMap: { [key: string]: React.ComponentType<{ className?: string }> } = {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 pt-16">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              size="lg" 
              className="text-lg px-8 py-4 bg-blue-500 text-white hover:bg-blue-600 font-semibold border-2 border-blue-500 hover:border-blue-600 shadow-lg"
